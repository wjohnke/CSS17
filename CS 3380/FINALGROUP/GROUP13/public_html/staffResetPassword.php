...
<?php
	...
	if($_SESSION['permission']=='customer'){
		header('Location: http://cs3380.rnet.missouri.edu/~GROUP13/resetPassword.php');
	}
	if(!$_SESSION){
...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
	...
	<a href="http://cs3380.rnet.missouri.edu/~GROUP13/Admin.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Profile</a>	
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:80px" id="showcase">
	...
	<div align="center" style="text-align: center">
		...
		Employee ID:<br>
		<input type="text" name="staffId" placeholder="####" required="required" style="text-align: center">
		<br><br>
		Old Password:<br>
 ...
 <?php
	...
	{
		$user = htmlspecialchars($_POST['staffId'],ENT_NOQUOTES);
		...
		if ($count==1)
		{
			...
			if(password_verify($word, $row['Password'])){
				$query3="UPDATE `EMPLOYEE` SET `Password`=? WHERE `Employee_Id`=?;";
				$stmt = $mysqli->stmt_init();
