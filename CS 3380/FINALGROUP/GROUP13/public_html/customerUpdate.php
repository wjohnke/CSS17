...
<?php
	if(isset($_POST['update'])){
		...
		$query = $query = "SELECT `CUSTOMER`.Customer_Id_Num AS 'Customer ID', `CUSTOMER`.First_Name AS 'First Name', `CUSTOMER`.Last_Name AS 'Last Name', `CUSTOMER`.Billing_Email AS 'Email' FROM `CUSTOMER` WHERE `CUSTOMER`.Customer_Id_Num ='$pk';";
...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
	...
	<div align="center">
		<form action="handleCustomerUpdate.php" method="POST">
			ID Number:<br>
			(Unable to edit)<br>
			<input type='text' style="text-align: center" name='id' readonly value='<?=$row[0]?>'></input>
			<br><br>
			First Name:<br>
			<input type='text' style="text-align: center" name='fName' value='<?=$row[1]?>'></input>
			<br><br>
			Last Name:<br>
			<input type='text' style='text-align: center' name='lName' value='<?=$row[2]?>'></input>
			<br><br>
			Password:<br>
			...
			Email:<br>
			(Unable to edit)<br>
			<input type='text' style="text-align: center" name='email' readonly value= '<?=$row[3]?>'></input>
			<br><br>
