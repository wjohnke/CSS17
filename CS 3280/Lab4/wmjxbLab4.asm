...
*
* Program description:
* This program uses a subroutine to iterate through two arrays
* and find the greatest common divisor of each number in equal positions
* amongst the arrays, and stores the result back in a result variable.
*
*
*
...
UNTIL	TST	REMAINDER	}   UNTIL (REMAINDER ==0)
	...
	LDAA	GCD
	PSHA		Puts GCD onto stack
	PSHX		Puts return address on top of stack
	LDX	XREG	X Has old Contents again
	RTS